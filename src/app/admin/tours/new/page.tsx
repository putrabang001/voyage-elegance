...
const sections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'itineraryEn', label: 'Itinerary (JSON)', type: 'textarea', rows: 4, placeholder: '[{"day": 1, "title": "Arrival", "description": "..."}]' },
      { name: 'includesEn', label: 'What\'s Included (JSON)', type: 'textarea', rows: 3, placeholder: '["Airport transfer", "Hotel", "Meals"]' },
      { name: 'excludesEn', label: 'Not Included (JSON)', type: 'textarea', rows: 3, placeholder: '["Flights", "Travel insurance"]' },
    ],
  },
  {
